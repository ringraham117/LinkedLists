...
class linked_list:
    ...
    def findLength(self):
        ...
        # Checks if the head node has a value
        if self.head.value == None:

            # Returns 0 to indicate that the list is empty
            return 0
...
print("\nBefore any nodes are added, the size of the linked list is: " + str(size))
...
print("\nAfter adding nodes, here's the initial list:")
myList.printList()
